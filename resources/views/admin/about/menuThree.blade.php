<div class="container afra-p-b-20">
    <form method="POST" action="{{url('admin/menuOneRecord')}}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" value="report" name="group_about">
        <div class="row">
            <div class="container ">
                <div class="row justify-content-center ">
                    <div class="col-md-12 afra-padd-bottom  ">
                        <div class="col-md-4 offset-md-1 afra-p-top2" >  <h4 > تعریف  {{$header->menu_three}} </h4></div>
                        <div class="form-group row afra-p-top2">
                            <label for="datepicker4" class="col-md-2 col-form-label text-md-right">{{ __('تاریخ گزارش *'  ) }}</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row ">
                            <label for="title" class="col-md-2 col-form-label text-md-right">{{ __('عنوان '.$header->menu_three.' *'  ) }}</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            <label for="description_one" class="col-md-2 col-form-label text-md-right">{{ __('توضیحات مختصر   *'  ) }}</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            <label for="description_two" class="col-md-2 col-form-label text-md-right">{{ __('توضیحات  تکمیلی *'  ) }}</label>
                            <div class="col-md-8">
...
<div class="col-md-4 d-none d-sm-block border ">توضیحات دو</div>
...
<div class="col-md-4 d-none d-sm-block border">{{$about->description_two}}</div>
    ...
    <div class="collapse   afra-w-100" id="collapseExample{{$about->id}}">
        <div class="card card-body right">
            <form method="post" action="/admin/editAbout" >
                ...
                <div class="form-group row">
                    <label for="description_two" class="col-md-2 col-form-label text-md-right">{{ __('توضیحات دوم'  ) }}</label>
                    <div class="col-md-8">
