    ...
    <div class="row   ">
        ...
        <div class="col-md-10   offset-md-2  afra-m-top-2 ">
            ...
            @if(session()->has('record'))
                <div class="alert alert-success ">
                    آپلود محصول  با موفقیت انجام شد .
                </div>
            @endif
            ...
            <div class="container afra-p-b-20">
                <form method="POST" action="{{url('admin/productRecord')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="container ">
                            <div class="row justify-content-center ">
                                <div class="col-md-12 afra-padd-bottom card ">
                                    <div class="col-md-4 offset-md-1 afra-p-top2" >  <h4 >تعریف محصول FTM</h4></div>
                                    ...
                                    <div class="form-group row">
                                        <label for="image_one " class="col-md-2 col-form-label text-md-right">{{ __('تصویر اول محصول') }}</label>
                                        <div class="col-md-8 ">
                                    ...
                                    <div class="form-group row">
                                        <label for="image_two " class="col-md-2 col-form-label text-md-right">{{ __('تصویر دوم محصول') }}</label>
                                        <div class="col-md-8 ">
                                    ...
                                    <div class="form-group row">
                                        <label for="image_three " class="col-md-2 col-form-label text-md-right">{{ __('تصویر سوم محصول') }}</label>
                                        <div class="col-md-8 ">
                ...
                <div class="row">
                    <div class="col-md-12 card  afra-p-b-20">
                        ...
                        <div class="row  {{$color->title}}" >
                            ...
                            <div class="col-md-3 d-none d-sm-block  border">عنوان محصول</div>
                            <div class="col-md-2 d-none d-sm-block border ">توضیحات محصول </div>
                            <div class="col-md-2 d-none d-sm-block border ">تصویر اصلی</div>
                            <div class="col-md-2 d-none d-sm-block border ">ویرایش </div>
                            <div class="col-md-2 d-none d-sm-block border ">حذف محصول </div>
                        </div>
                        @foreach ($products as $product)
                            <div class="row  " >
                                <div class="col-md-1 d-none d-sm-block border">
                                    @if($product->active == "1")
                                        <form method="post" action="/admin/inactiveProducts" >
                                            @csrf
                                    ...
                                    @else
                                        <form method="post" action="/admin/activeProducts" >
                                            @csrf
                                            <input  name="id" type="hidden"  value="{{$product->id}}">
                                            <button type="submit"  class="btn afra-btn-hide">
                                ...
                                <div class="col-md-3 d-none d-sm-block border">{{$product->title}}</div>
                                <div class="col-md-2 d-none d-sm-block border">{{$product->description}}</div>

                                <div class="col-md-2 d-none d-sm-block border "><img src="products//{{$product->image_one}}" alt="ftm" width="100" />  </div>
                                <div class="col-md-2 d-none d-sm-block border center">
                                    <form method="POST" action="" >
                                        ...
                                        <button type="button"   data-toggle="modal" data-target=".bd-example-modal-lg"  class="btn {{$color->main_three}}
                                                afra-white" onClick="formget(this.form,'/admin/editProducts');">
                                ...
                                <div class="col-md-2 d-none d-sm-block border center">
                                    <form method="post" action="/admin/deleteProducts" >
                                        @csrf
                                        <input  name="id" type="hidden"  value="{{$product->id}}">
                                        <button type="submit"  class="btn afra-btn-hide">
